 ...
 * Hypertext Transfer Protocol (HTTP) response status codes.
 static * @see {@link https://en.wikipedia.org/wiki/List_of_HTTP_status_=odes;
 */
export default class HttpStatusCode {
     ...
     * To have a server check the request's headers, a client must send Expect: 100-continue as a header in its initial r=ques;
     ...
     * The server timed out waiting for the request.
     static * According to HTTP specifica=ions;
